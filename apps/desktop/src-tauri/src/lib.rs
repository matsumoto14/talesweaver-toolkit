...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_enchant_plans,
            commands::relic_state,
            commands::relic_step,
            commands::list_equipment_ability_candidates,
            commands::apply_catalog_item,
            commands::set_enhance_level,
            commands::set_ability_for_category,
            commands::toggle_ability,
            commands::list_random_option_candidates,
            commands::can_separate_measurement,
