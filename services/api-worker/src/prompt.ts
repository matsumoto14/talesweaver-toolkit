...
(g) 候補に該当する答えが無ければ none を true にして空で返す。無理に埋めない。
    **質問の要点に触れていない断片しか無いときは none**(同じページの別の話・言葉が似ているだけの行は
    「近い」ではなく「無い」。none にする方が正しい)
