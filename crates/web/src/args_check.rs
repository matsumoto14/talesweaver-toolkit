...
fn expected_args(command: &str) -> Option<BTreeSet<String>> {
    ...
    let fields = match command {
        ...
        "normalize_character_skills" => arg_fields::<NormalizeCharacterSkillsArgs>(),
        ...
        "validate_character" | "list_enchant_plans" => arg_fields::<CharacterArgs>(),
        ...
        "set_ability_for_category" => arg_fields::<SetAbilityForCategoryArgs>(),
        "toggle_ability" => arg_fields::<ToggleAbilityArgs>(),
        "list_random_option_candidates" => arg_fields::<RandomOptionCandidatesArgs>(),
        "can_separate_measurement" => arg_fields::<CanSeparateMeasurementArgs>(),
