...
# 破壊精霊(アンフェル / グレシス / イグニー)も同じ理由で 3D モデル。召喚スキル「アンフェル召喚」
# 「グレシス召喚」「イグニー召喚」(クライアント DB 0006 の 3002607 / 3002608 / 3002609。アイコン指定
# {"id":95596,"w":34|35|36} → アニメ 95596 の 34 / 35 / 36 番 → テクスチャ 13322 のコマ 65 / 67 / 69)を使う。
# gamedata には召喚スキルが無い(攻撃スキルだけ)ので、id は「あれば付くはずの id」で置く。
# 計算タブの熊 / 精霊の鎖のバッジが `skills/` から引く(docs/adr/016)
FROM_SPRITE: dict[tuple[str, str], str] = {
    ...
    ("skills", "anais_anferu_summon"): "0133__13322_f065",
    ("skills", "anais_gureshisu_summon"): "0133__13322_f067",
    ("skills", "anais_igni_summon"): "0133__13322_f069",
}
